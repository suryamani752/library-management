...
export const UpdateBook = () => {
  ...
  const [book, setBook] = useState({ _id: location.state._id });
  ...
  useEffect(() => {
    if (location.state !== null)
      setTempBook({
        ...
        book_depository_stars: location.state.book_depository_stars,
      });
  }, []);
        ...
        <div class="container px-4 py-5 mx-auto">
          <div class="cardd card0">
            <div class="d-flex flex-lg-row flex-column-reverse">
                      ...
                      <div className="field addbook">
                        <input
                          ...
                          onChange={(e) => {
                            setTempBook({
                              ...tempbook,
                              book_depository_stars: e.target.value,
                            });
                            setBook({
                              ...book,
                              book_depository_stars: e.target.value,
              ...
              <div class="cardd card2 addbook updateBookImage">
                {" "}
                <img id="image" src={location.state.image} />{" "}
              </div>
            </div>
          </div>
        </div>
