          ...
          <div className="row g-0 cardRow">
            ...
            <div className="col-md-6">
              <div className="card-body cardBody">
                ...
                <p className="card-text text-muted cardText">
                  By {location.state.author}
                </p>
                <div className="bookDetails">
                  {/* <p><span className='titles'>Format: </span>Paperback</p> */}
                  <p>
                    <span className="titles">Language: </span>English
                  </p>
                  <p>
                    <span className="titles">Pages: </span>
                    {location.state.pages}
                  </p>
                  <p>
                    <span className="titles">Publisher: </span>
                    {location.state.publisher}
                  </p>
                  <p>
                    <span className="titles">ISBN: </span>
                    {location.state.isbn}
                  </p>
                  <p>
                    <span className="titles">Rating: </span>
                    {location.state.book_depository_stars}
                  </p>
                  <p>
                    <span className="titles">Category: </span>
                    {location.state.category}
                  </p>
                  <p>
                    <span className="titles">Available Copies: </span>
                ...
                {role === "user" ? (
                  <>
                    <button
                      ...
                      onClick={issueFunc}
                      className={
                        "btn btn-block issue-btn " +
                        (btnValue === "Not available"
                  ...
                  <>
                    <button
                      type="button"
                      onClick={() => deleteFunc(location.state.isbn)}
                      className="btn delete-btn btn-dark ms-4 me-3"
                    >
                      Delete
                    </button>
                    <button
                      type="button"
                      onClick={() =>
                        navigate("/dashboard/viewBooks/updateBook", {
